...
class VillaPhotos extends Table with TableInfo<VillaPhotos, VillaPhotosData> {
  ...
  late final GeneratedColumn<String> villaId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES villas(id)ON DELETE CASCADE',
  );
...
class Bookings extends Table with TableInfo<Bookings, BookingsData> {
  ...
  late final GeneratedColumn<String> villaId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES villas(id)ON DELETE RESTRICT',
  );
...
class Invoices extends Table with TableInfo<Invoices, InvoicesData> {
  ...
  late final GeneratedColumn<String> bookingId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES bookings(id)ON DELETE RESTRICT',
  );
  late final GeneratedColumn<String> guestName = GeneratedColumn<String>(
    'guest_name',
    aliasedName,
