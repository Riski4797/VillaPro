...
class AppSettings extends Table {
  ...
  TextColumn get invoiceFooterNote => text().withDefault(
    const Constant(
      'Harap simpan bukti pembayaran dan tunjukkan saat proses check-in.',
    ),
  )();
  TextColumn get templateTeaser => text().withDefault(
    const Constant(
      '{nama_villa} - {lokasi}\nHarga mulai {harga_weekday}/malam\n{keunggulan}\nMau info lengkap? Chat aja ya kak 🙏',
    ),
  )();
  TextColumn get templateDetail => text().withDefault(
    const Constant(
  ...
  TextColumn get templateButlerNotification => text().withDefault(
    const Constant(
